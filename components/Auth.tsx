...
const Auth: React.FC<AuthProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-md overflow-hidden flex flex-col border border-slate-100">
        <div className="bg-indigo-600 p-10 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-600 to-indigo-900 opacity-95"></div>
            <div className="relative z-10">
                <div className="flex justify-center mb-6">
                    <ShieldCheck className="w-20 h-20 text-white drop-shadow-2xl" />
                </div>
                <h1 className="text-4xl font-black text-white mb-2 italic tracking-tighter uppercase">FluxLedger</h1>
